...
alter table "public"."individuals" add constraint "individuals_org_id_fkey" FOREIGN KEY (org_id) REFERENCES organizations(id) not valid;

alter table "public"."individuals" validate constraint "individuals_org_id_fkey";

alter table "public"."orders" add constraint "orders_org_id_fkey" FOREIGN KEY (org_id) REFERENCES organizations(id) not valid;

alter table "public"."orders" validate constraint "orders_org_id_fkey";

alter table "public"."organizations" add constraint "organizations_org_id_fkey" FOREIGN KEY (org_id) REFERENCES organizations(id) not valid;

alter table "public"."organizations" validate constraint "organizations_org_id_fkey";

alter table "public"."products" add constraint "products_org_id_fkey" FOREIGN KEY (org_id) REFERENCES organizations(id) not valid;

alter table "public"."products" validate constraint "products_org_id_fkey";

alter table "public"."push_subscriptions" add constraint "push_subscriptions_org_id_fkey" FOREIGN KEY (org_id) REFERENCES organizations(id) not valid;
